...
<body onload="onLoaderFunc()">
    ...
    <div class="container">
        ...
        <div class="sel-reg">
            ...
            <div class="inputForm">
                <h2>Masukan Data dan Lakukan Pilih Kursi</h2>
                <div class="mr_movmain">
                    <div class="movits-left">
                            <label> Pilih Rute
                                <span>*</span>
                            </label>
                            <select name="ruteBerangkat" id="RuteBerangkat" style="width: 300px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;" required/>
						<?php
						include('db.php');
